  ...
  return (
    <div className="relative rounded-2xl shadow-xl bg-white/40 dark:bg-green-900/30 backdrop-blur-md border border-green-100/30 dark:border-green-900/30 overflow-x-auto">
      ...
      <div className="pointer-events-none select-none">
        <svg className="absolute -top-10 -right-10 w-64 h-64 opacity-10 text-green-300 z-0" fill="none" viewBox="0 0 200 200"><circle cx="100" cy="100" r="100" fill="currentColor" /></svg>
        <svg className="absolute bottom-0 left-0 w-40 h-40 opacity-10 text-green-200 z-0" fill="none" viewBox="0 0 160 160"><circle cx="80" cy="80" r="80" fill="currentColor" /></svg>
      </div>
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm text-green-900 dark:text-green-100">
                    <select
                      ...
                      className="cursor-pointer w-full px-2 py-1 border rounded bg-white/30 dark:bg-green-900/30 text-green-800 dark:text-green-100 shadow-md"
                    >
                      <option value="unpaid" className="bg-red-100 text-red-800 rounded-full px-2 py-1">Unpaid</option>
                      <option value="partially_paid" className="bg-yellow-100 text-yellow-800 rounded-full px-2 py-1">Partially Paid</option>
                      <option value="paid" className="bg-green-100 text-green-800 rounded-full px-2 py-1">Paid</option>
                      <option value="refund_pending" className="bg-orange-100 text-orange-800 rounded-full px-2 py-1">Refund Pending</option>
                      <option value="refunded" className="bg-blue-100 text-blue-800 rounded-full px-2 py-1">Refunded</option>
                      <option value="failed" className="bg-gray-100 text-gray-800 rounded-full px-2 py-1">Failed</option>
                    </select>
                  </td>
                  <td className="px-6 py-4 text-sm text-green-900 dark:text-green-100">{new Date(booking.created_at).toLocaleDateString()}</td>
                </tr>
                {expandedId === booking.id && (
                  <tr>
                    <td colSpan={6} className="bg-white/80 dark:bg-green-900/60 border-t border-green-100/40 dark:border-green-900/40 shadow-lg text-green-900 dark:text-green-100 p-6">
