...
const AdminPaymentsStats: FC<AdminPaymentsStatsProps> = ({ totalPayments, totalAmount, totalUsers, totalAgents }) => (
  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6 *:shadow-xl">
    <div className="bg-green-100 dark:bg-green-900/40 rounded-xl p-4 text-center">
      <div className="text-2xl font-bold text-green-700 dark:text-green-200"><FaMoneyBillAlt /></div>
    ...
    <div className="bg-green-100 dark:bg-green-900/40 rounded-xl p-4 text-center">
      <div className="text-2xl font-bold text-green-700 dark:text-green-200"><FaMoneyBillTransfer /></div>
    ...
    <div className="bg-green-100 dark:bg-green-900/40 rounded-xl p-4 text-center">
      <div className="text-2xl font-bold text-green-700 dark:text-green-200"><FaUserAlt /></div>
    ...
    <div className="bg-green-100 dark:bg-green-900/40 rounded-xl p-4 text-center">
      <div className="text-2xl font-bold text-green-700 dark:text-green-200"><FaUserGroup /></div>
