      ...
      <main className="flex flex-col items-center justify-center min-h-screen bg-lightmode-bg-color dark:bg-darkmode-bg-color pt-24 pb-12 px-2">
        <section className="w-full max-w-3xl mx-auto rounded-3xl border border-green-200 dark:border-green-900/40 bg-white/60 dark:bg-green-900/40 backdrop-blur-lg shadow-xl p-8 md:p-12 mt-8">
          ...
          <div className="prose prose-green dark:prose-invert max-w-none text-base md:text-lg">
            <h2 className="text-green-900">1. Acceptance of Terms</h2>
            ...
            <h2 className="text-green-900">2. User Accounts</h2>
            <ul>
            ...
            <h2 className="text-green-900">3. Bookings &amp; Payments</h2>
            <ul>
            ...
            <h2 className="text-green-900">4. Cancellations &amp; Refunds</h2>
            <ul>
            ...
            <h2 className="text-green-900">5. User Conduct</h2>
            <ul>
            ...
            <h2 className="text-green-900">6. Intellectual Property</h2>
            ...
            <h2 className="text-green-900">7. Limitation of Liability</h2>
            ...
            <h2 className="text-green-900">8. Changes to Terms</h2>
            ...
            <h2 className="text-green-900">9. Contact</h2>
