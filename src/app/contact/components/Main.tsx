      ...
      <section className="py-32">
        <div className="mx-auto max-w-4xl px-4 lg:px-0">
          ...
          <form action="" className="border px-4 py-12 lg:px-0 lg:py-24">
            <Card className="mx-auto max-w-lg p-8 sm:p-16 shadow-xl bg-lightmode-auth-bg-color dark:bg-darkmode-auth-bg-color backdrop-blur-md">
            <HeaderLogo />
              <h3 className="text-2xl text-green-800 dark:text-green-200 font-semibold">
              Reach out to our support team
              </h3>
              <p className="mt-2 text-sm md:text-md lg:text-lg text-green-600">
