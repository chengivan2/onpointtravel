      ...
      <section className="flex flex-col md:flex-row mt-16 min-h-screen bg-transparent">
        ...
        <div className="bg-center bg-cover bg-[url(/images/signin.jpg)] md:bg-none relative min-h-full flex flex-row justify-center items-center flex-2/3">
          <form
            ...
            className="backdrop-blur-lg bg-lightmode-auth-bg-color/80 md:bg-lightmode-auth-bg-color dark:bg-darkmode-auth-bg-color/80 dark:md:bg-darkmode-auth-bg-color m-auto h-fit w-full max-w-sm rounded-[0.85rem] p-0.5 shadow-md"
          >
