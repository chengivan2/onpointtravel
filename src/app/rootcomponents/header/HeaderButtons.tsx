...
export default function HeaderButtons() {
  return (
    <div className="min-w-full flex flex-col md:flex-row items-center gap-[1rem] space-x-3">
      <Link href="/" className="min-w-full px-4 py-2 rounded-full text-sm font-medium
