...
export function BookingForm({
  ...
  return (
    <section id={`Book ${trip.name}`} className="bg-white/60 dark:bg-green-900/20 rounded-xl shadow-lg p-8 border border-green-100/30 dark:border-green-900/30 mt-12">
