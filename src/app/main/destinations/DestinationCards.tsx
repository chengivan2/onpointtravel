        ...
        return (
          ...
          >
            <Link href={`/destinations/${destination.slug}`}>
              <div className="relative z-10 h-full flex flex-col bg-white/60 dark:bg-green-900/60 backdrop-blur-md border border-gray-200/40 dark:border-green-900/30 rounded-xl p-6 transition-all duration-300 hover:bg-white/40 dark:hover:bg-green-900/30 shadow-sm hover:shadow-md">
