          ...
          {trips.map((trip, index) => (
            ...
            >
              <Link href={`/trips/${trip.slug}`}>
                <div className="group relative backdrop-blur-md bg-green-900/60 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-green-100/30 dark:border-green-900/30 overflow-hidden">
                  {/* Image Section */}
