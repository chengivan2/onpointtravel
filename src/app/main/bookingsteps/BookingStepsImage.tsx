...
export default function BookingStepsImage() {
  return (
    <div className="flex-1 w-full max-w-xl">
      <div className="relative rounded-2xl shadow-xl sm:border-green-100/30 dark:border-green-900/30 hover:shadow-xl p-8 border bg-white/30 dark:bg-green-900/30 backdrop-blur-sm backdrop-saturate-150">
