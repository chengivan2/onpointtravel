...
export default function DestinationCard({
  ...
  return (
    <Link
      ...
      className="block group rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 bg-white/50 dark:bg-green-900/50 backdrop-blur-md border border-green-100/30 dark:border-green-900/30"
    >
